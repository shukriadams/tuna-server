...
module.exports = {
    ...
    bind(app){
        ...
        app.get('/v1/songs/stream/:authToken/:mediaPath', async function (req, res) {
            try {
                const authToken = await authHelper.authenticateTokenString(req.params.authToken),
        ...
        app.post('/v1/songs/import', async function(req, res){
            try {
                ...
                const content = await contentHelper.build(authToken.profileId, authToken.id, 'songs,playlists');
